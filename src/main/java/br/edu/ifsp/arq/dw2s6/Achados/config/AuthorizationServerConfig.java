package br.edu.ifsp.arq.dw2s6.Achados.config;
...
import br.edu.ifsp.arq.dw2s6.Achados.security.SystemUser;
...
public class AuthorizationServerConfig {
    ...
    OAuth2TokenCustomizer<JwtEncodingContext> jwtBuildCustomizer() {
        return (context) -> {
            ...
            context.getClaims().claim("idUsuario", systemUser.getUser().getIdUsuario());
            context.getClaims().claim("nome", systemUser.getUser().getNome());
    ...
    JWKSet jwkSet() throws Exception {
        final InputStream inputStream = new ClassPathResource("keystore/achados.jks")
        		.getInputStream();
